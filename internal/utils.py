...
Rays = collections.namedtuple(
    'Rays',
    ('origins', 'directions', 'viewdirs', 'radii', 'lossmult', 'near', 'far','temperature','exposure','coc'))
...
class Config:
  ...
  max_steps: int = 300000  # The number of optimization steps.
  ...
  data_dir:str = "horns"
  train_dir:str = "experiments/horns"
  render_temp:float = 3500.
  render_exp:float = 0.5
